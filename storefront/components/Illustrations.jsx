...
export const LaptopImg = (p) => (
  <svg viewBox="0 0 200 150" {...p}>
    <rect x="45" y="28" width="110" height="70" rx="4" fill="#1f2937" />
    <rect x="50" y="33" width="100" height="60" rx="2" fill="#2563eb" />
    <rect x="50" y="33" width="100" height="60" rx="2" fill="url(#lapg)" />
    <path d="M30 98h140l10 16H20z" fill="#cbd5e1" />
    <rect x="30" y="98" width="140" height="6" fill="#94a3b8" />
    <rect x="82" y="106" width="36" height="4" rx="2" fill="#64748b" />
    <defs>
      <linearGradient id="lapg" x1="0" y1="0" x2="1" y2="1">
...
export const PrinterImg = (p) => (
  <svg viewBox="0 0 200 150" {...p}>
    ...
    <rect x="120" y="46" width="26" height="10" rx="2" fill="#3b82f6" />
    <circle cx="60" cy="51" r="3" fill="#22c55e" />
    <rect x="150" y="55" width="14" height="34" rx="3" fill="#475569" />
  </svg>
)

export const TonerImg = (p) => (
  <svg viewBox="0 0 200 150" {...p}>
    ...
    <rect x="118" y="70" width="20" height="14" rx="2" fill="#3b82f6" />
  </svg>
)
...
export const HeadsetImg = (p) => (
  <svg viewBox="0 0 200 150" {...p}>
    ...
    <rect x="68" y="128" width="24" height="8" rx="4" fill="#3b82f6" />
  </svg>
)
