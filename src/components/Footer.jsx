...
import { Lock, ShieldCheck, Truck, Headset, Whatsapp, Facebook, Instagram, Youtube, Mail } from './Icons.jsx'

/* Sellos de medios de pago (marcas genéricas para el pie). */
const PaymentMarks = () => (
...
/* Sellos de confianza (tarjetas oscuras en la parte superior del pie). */
const footTrust = [
...
/* Pie de página minimalista para el checkout. */
...
const columns = [
  {
    title: 'Mi cuenta',
    links: [
      ['Mis pedidos', '/cuenta'], ['Mis direcciones', '/cuenta'],
      ['Cambiar contraseña', '/cuenta'], ['Crear cuenta', '/cuenta'],
    ],
  },
  {
    title: 'La empresa',
    links: [
      ['Sobre nosotros', '/legal/quienes-somos'], ['Nuestra tienda', '/legal/quienes-somos'],
      ['Contacto', '/cotizacion'], ['Ventas corporativas', '/cotizacion'],
    ],
  },
  {
        ...
        <div className="footer2-grid">
          <div className="footer2-news">
            ...
            <label className="news2-check">
              ...
              <span>Acepto los <Link to="/legal/terminos">términos y políticas</Link> del sitio.</span>
            </label>
